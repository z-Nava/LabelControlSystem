...
class StoreSkuSerialFormatRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        $this->merge([
            ...
            'serial_scheme' => $isUl ? 'ul_standard' : trim((string) $this->input('serial_scheme', $defaultScheme)),
            'description' => $this->input('description'),
            'serial_length' => $isUl ? null : $this->input('serial_length'),
            'qr_payload_format' => $isUl ? 'serial_only' : trim((string) $this->input('qr_payload_format', $defaultQrMode)),
            'date_mode' => $isUl ? 'year_week' : trim((string) $this->input('date_mode', $defaultDateMode)),
