...
>
    ...
    <section class="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm md:p-6">
        ...
        <div class="grid grid-cols-1 gap-6 2xl:grid-cols-12">
            <div class="space-y-5 2xl:col-span-7">
                {{-- Texto principal / Rating --}}
                <div class="rounded-2xl border border-slate-200 p-4" data-layout-section="rating">
                    <div class="mb-4 flex flex-col gap-2 md:flex-row md:items-start md:justify-between">
                        <div>
                            <h3 class="text-base font-bold text-slate-900">A. Bloque de texto principal</h3>
                            <p class="mt-1 text-xs text-slate-500">
                                Se usa para Rating y también como texto base en layouts simples.
                            </p>
                        </div>
                        <span class="rounded-full bg-slate-100 px-3 py-1 text-xs font-semibold text-slate-600">SN / Rating</span>
                    </div>

                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-4">
                        <div>
                            <label class="block text-sm font-semibold text-slate-700">Serial X</label>
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-slate-700">Serial Y</label>
                ...
                {{-- QR --}}
                <div class="rounded-2xl border border-slate-200 bg-slate-50 p-4" data-layout-section="serial">
                    <div class="mb-4 flex flex-col gap-2 md:flex-row md:items-start md:justify-between">
                        <div>
                ...
                <div class="rounded-2xl border border-slate-200 p-4" data-layout-section="serial-text">
                    <div class="mb-4">
                        <h3 class="text-base font-bold text-slate-900">C. Texto visible en etiqueta Serial</h3>
                        <p class="mt-1 text-xs text-slate-500">Configura el SKU principal, el SN pequeño y la repetición de bloques.</p>
                    </div>
            ...
            <aside class="2xl:col-span-5">
                <div class="sticky top-4 rounded-3xl border border-slate-200 bg-white p-4 shadow-sm" id="live-print-preview">
                    ...
                    <div class="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                        ...
                        <div class="mt-3 flex min-h-[220px] items-center justify-center rounded-2xl border border-dashed border-slate-300 bg-white p-4">
                            <div id="live-preview-qr" class="flex h-40 w-40 items-center justify-center rounded-xl bg-slate-50 text-center text-xs text-slate-500">
                                QR no disponible
                            </div>
                        </div>
                    ...
                    <div class="mt-4 rounded-2xl border border-slate-200 bg-slate-50 p-4">
                        ...
                        <dl class="mt-3 space-y-3 text-sm text-slate-700">
                            <div class="grid grid-cols-3 gap-2">
                                ...
                                <dd id="live-preview-standard" class="col-span-2">—</dd>
                            </div>
                            <div class="grid grid-cols-3 gap-2">
                                <dt class="font-semibold text-slate-900">Tipo</dt>
                                <dd id="live-preview-label-type" class="col-span-2">—</dd>
                            </div>
                            <div class="grid grid-cols-3 gap-2">
                                <dt class="font-semibold text-slate-900">Modo QR</dt>
                                <dd id="live-preview-qr-mode" class="col-span-2">—</dd>
                            </div>
                            <div class="grid grid-cols-3 gap-2">
                                <dt class="font-semibold text-slate-900">Formato SN</dt>
                                <dd id="live-preview-serial-style" class="col-span-2">—</dd>
                            </div>
                            <div>
