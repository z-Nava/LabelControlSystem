@extends('layouts.app', ['title' => 'Nueva configuración template UL'])
...
<div class="bg-white rounded-2xl shadow p-6">
    ...
    <form class="mt-6 space-y-4" method="POST" action="{{ route('admin.sku_template_configurations.store') }}">
        @include('admin.sku_template_configurations._form', ['configuration' => $configuration, 'formState' => $formState, 'forcedStandard' => 'UL'])
