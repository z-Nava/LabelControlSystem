...
>
    ...
    <section class="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
        <div class="border-b border-red-700 bg-red-700 px-5 py-5 text-white md:px-6">
            ...
            <h1 class="mt-2 text-2xl font-bold">Template y perfil ANZ por SKU</h1>
        ...
        <div class="grid grid-cols-1 gap-5 xl:grid-cols-12">
            <div class="space-y-5 xl:col-span-8">
                <div class="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    ...
                    <input type="hidden" name="serial_standard" id="serial_standard" value="ANZ">
            ...
            <aside class="space-y-5 xl:col-span-4">
                <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                    ...
                    <div class="mt-4 space-y-3">
                        ...
                        <div class="rounded-xl border border-slate-200 bg-slate-50 p-3 text-xs text-slate-600">
                            Este formulario está bloqueado a ANZ; usa únicamente SKUs y reglas de impresión ANZ.
                        </div>
                    </div>
                </div>
                ...
                >
                    <p class="text-xs font-semibold uppercase tracking-wide text-slate-500">Opciones Rating ANZ</p>
                    ...
                    <label class="mt-3 flex items-start gap-3 rounded-xl bg-white p-3 text-sm text-slate-700">
                        ...
                        <span>
                            ...
                            <span class="mt-1 block text-xs text-slate-500">En ANZ se usa para etiquetas Rating con SN + QR, sin SKU visible.</span>
                        </span>
                    </label>
                </div>
            </aside>
