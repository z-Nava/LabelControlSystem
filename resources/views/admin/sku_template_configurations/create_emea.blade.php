@extends('layouts.app', ['title' => 'Nueva configuración template EMEA', 'mainClass' => 'max-w-screen-2xl'])
...
<div class="bg-white rounded-2xl shadow p-4 sm:p-6 xl:p-8">
    ...
    <form class="mt-6 space-y-4" method="POST" action="{{ route('admin.sku_template_configurations.store') }}">
        @include('admin.sku_template_configurations._form_emea', ['configuration' => $configuration, 'formState' => $formState, 'forcedStandard' => 'EMEA'])
