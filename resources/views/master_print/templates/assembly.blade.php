                ...
                <div class="min-w-[250mm] overflow-hidden rounded-[2.5mm] border border-black bg-white shadow-sm print:rounded-none print:shadow-none">
                    <table class="w-full table-fixed border-collapse text-black">
                        ...
                        <tr class="h-[14mm]">
                            ...
                            <td colspan="2" class="border border-black p-[1.2mm] text-center text-[18px] font-extrabold">{{ $s['folio_no'] ?? '' }}</td>
                            <td class="border border-black bg-[#fff8d9] p-[1.2mm] text-center font-bold">{{ $s['date'] ?? '' }}</td>
                        </tr>
