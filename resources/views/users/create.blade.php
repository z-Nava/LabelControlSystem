...
<div class="bg-white rounded-2xl shadow p-6 max-w-4xl">
    ...
    <p class="text-slate-600 mt-1">Registrar alta de usuario y asignar roles.</p>

    <form class="mt-6 space-y-4" method="POST" action="{{ route('users.store') }}">
        @include('users._form')

        <div class="pt-2 flex gap-2">
            <button class="rounded-xl bg-red-600 text-white px-4 py-2 font-semibold hover:bg-red-500 transition">Guardar</button>
